    ...
    <div class="wrap">
        ...
        <main class="container">
			<div class="my-3 col-md-9 mx-auto">
                ...
                <label for="wirter" class="form-label mt-3"><i class="fa-solid fa-user-pen text-danger"></i> <b>Wirter</b></label>
                <input type="text" class="form-control" id="wirter" placeholder="wirter" name="wirter" value="${post.writer}" disabled>
